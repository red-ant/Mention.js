...
;(function($) {
  ...
  function patchTypeahead() {
    ...
    var typeahead = {
      ...
      show:   $.fn.typeahead.Constructor.prototype.show
    };
    ...
    $.fn.typeahead.Constructor.prototype.render = function(items) {
      return (this.options.mention ? mention.render : typeahead.render).call(this, items);
    };

    $.fn.typeahead.Constructor.prototype.show = function() {
      return (this.options.mention ? mention.show : typeahead.show).call(this);
    };
  }
